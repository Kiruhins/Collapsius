...
public class configuration_editable extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_2players=findViewById(R.id.bt_player2_2);
        bt_3players=findViewById(R.id.bt_player3_3);
        bt_4players=findViewById(R.id.bt_player4_4);
